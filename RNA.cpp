...
char valencyToChar(int val)
{
    ...
    {
    case 1:
        return 'T'; // Turn (convex)
    case 2:
        return 'A'; // Ahead
    case 3:
        return 'C'; // Concave turn
    case 4:
        return 'G'; // Go back
    case 5:
        return 'U'; // extreme convex valency...
    case 6:
        return 'V';
    case 7:
        return 'W';
    ...
    default:
    {
        ...
        if (letter < nLetters)
            return 'A' + letter;
        else if (letter < nLetters * 2)
            return 'a' + (letter - nLetters);
        else
            return '!'; // 132 + (letter-nLetters*2);
    }
    }
}
...
int charToValency(char c)
{
    ...
    case 'A':
        return 2; // Ahead
    case 'C':
        return 3; // Concave turn
    case 'G':
        return 4; // Go back
    case 'T':
        return 1; // Turn (convex)
    case 'U':
        return 5; // extreme convex valencies
    case 'V':
        return 6;
    case 'W':
        return 7;
